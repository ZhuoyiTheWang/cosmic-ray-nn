...
results = np.load('/home/zwang/cosmic-ray-nn/testing/testing_details/model_predictions.npz')
...
plt.legend()
plt.savefig(f'/home/zwang/cosmic-ray-nn/testing/testing_details/counts_vs_predicition.png')